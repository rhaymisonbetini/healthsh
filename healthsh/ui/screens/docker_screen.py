...
_SUBTITLE: str = "containers · coming in sprint 3"


class DockerScreen(QWidget):
    """Docker screen — placeholder until the real composition ships."""
    ...
    def __init__(self, *, parent: QWidget | None = None) -> None:
        ...
        description = QLabel(
            "Container cards, live actions and the no-Docker informational state land in issue #19."
        )
