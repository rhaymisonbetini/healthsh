...
_SUBTITLE: str = "configuration · coming in sprint 6"


class SettingsScreen(QWidget):
    """Settings screen — placeholder until the real composition ships."""
    ...
    def __init__(self, *, parent: QWidget | None = None) -> None:
        ...
        description = QLabel("Five live-applying configuration sections land in issue #29.")
