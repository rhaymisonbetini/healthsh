...
_SUBTITLE: str = "assistant · coming in sprint 5"


class AIScreen(QWidget):
    """AI screen — placeholder until the real composition ships."""
    ...
    def __init__(self, *, parent: QWidget | None = None) -> None:
        ...
        description = QLabel(
            "Tool-call-visible chat against Ollama / Anthropic / OpenAI lands in issue #27."
        )
